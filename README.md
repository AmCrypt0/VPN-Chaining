...
بعد از گذشت چند روز از قطعی سراسری اینترنت در سال 98 و راه اندازی مجدد اپلیکیشن ها و سرویس های داخلی تصمیم گرفتم که من هم راهی برای دسترسی به اینترنت پیدا کنم. یکی از دوستانم یه سرویس کاهش پینگ برای بازی های آنلاین تهیه کرده بود که سرور هاش داخل کشور بود. امتحان کردم و بسیار متعجب شدم که دسترسی به اینترنت داشت البته با فیلترینگ.
سریعا از یکی از همکارانم یه سرور مجازی ایران گرفتم و با ایجاد کانکشن وایرگارد بهش وصل شدم و دیدم که به اینترنت دسترسی داره و سعی کردم با استفاده از روش VPN Chaining سرور مجازی داخل رو به سرور خودم در اروپا متصل کنم و موفق شدم که به اینترنت آزاد دسترسی داشته باشم.
